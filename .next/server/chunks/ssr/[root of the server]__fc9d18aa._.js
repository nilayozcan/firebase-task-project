...
"[project]/src/lib/initialData.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            if (storedUsers) {
                ...
                usersToLoad = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$initialData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialUserProfilesData"];
            }
            usersToLoad = usersToLoad.filter((user)=>user.username && user.username.trim() !== '');
            setAllUsers(usersToLoad.map((user)=>({
                    ...user,
                    dateOfBirth: user.dateOfBirth ? new Date(user.dateOfBirth) : undefined
                })));
            const currentUserId = localStorage.getItem('currentUserId');
            if (currentUserId) {
                const foundUser = usersToLoad.find((u)=>u.id === currentUserId);
            ...
            if (storedTaskLists) {
                setTaskLists(JSON.parse(storedTaskLists).map((list)=>({
                        ...list,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fc9d18aa._.js.map